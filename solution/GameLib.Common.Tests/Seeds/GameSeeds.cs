...
{
    public static GameEntity TestGame => new()
    {
    ...
    public static GameEntity GameWithCategories => new()
    {
    ...
    public static GameEntity GameWithLibraries => new()
    {
    ...
    public static GameEntity GameUpdate => new()
    {
    ...
    public static GameEntity GameDelete => new()
    {
